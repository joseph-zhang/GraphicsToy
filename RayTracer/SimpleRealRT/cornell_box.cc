...
hitable* cornell_box() {
    ...
    list[i++] = new translate(new rotate_y(new block(vec3(0, 0, 0), vec3(165, 165, 165), white), -18), vec3(130,0,65));
    list[i++] = new translate(new rotate_y(new block(vec3(0, 0, 0), vec3(165, 330, 165), white),  15), vec3(265,0,295));
