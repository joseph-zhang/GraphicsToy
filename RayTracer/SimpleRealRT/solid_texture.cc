...
hitable* random_scene() {
  ...
  texture* checker = new checker_texture(new constant_texture(vec3(0.5, 0.5, 0.5)),
  ...
  list[i++] = new sphere(vec3(4,1,0), 1.0, new lambertian(new constant_texture(vec3(0.3, 0.5, 0.2))));
